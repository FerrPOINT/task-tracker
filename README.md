...
- `docs/` — архитектура, ТЗ, дата-модель, API, workflow, JQL, user stories, UI/UX, frontend-библиотеки, производительность, тестирование, библиотеки, отчёт по Vikunja, Jira capture
