...
> Стартовый документ. До конца разработки границы контекстов, поля агрегатов и бизнес-правила могут измениться — актуализировать при появлении реального кода.
