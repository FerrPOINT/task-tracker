...
Frontend — одностраничное React-приложение на Vite 6 + TypeScript 5.9 + Tailwind CSS 4 + shadcn/ui. Архитектура построена по методологии **Feature-Sliced Design (FSD)** с элементами **Atomic Design** для презентационных компонентов.
