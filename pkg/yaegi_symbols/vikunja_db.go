// Code generated by 'yaegi extract github.com/FerrPOINT/task-tracker/pkg/db'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/FerrPOINT/task-tracker/pkg/db/db"] = map[string]reflect.Value{
