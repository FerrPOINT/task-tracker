// Code generated by 'yaegi extract github.com/FerrPOINT/task-tracker/pkg/log'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/FerrPOINT/task-tracker/pkg/log/log"] = map[string]reflect.Value{
