// Code generated by 'yaegi extract github.com/FerrPOINT/task-tracker/pkg/events'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/FerrPOINT/task-tracker/pkg/events/events"] = map[string]reflect.Value{
