// Code generated by 'yaegi extract github.com/FerrPOINT/task-tracker/pkg/plugins'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/FerrPOINT/task-tracker/pkg/plugins/plugins"] = map[string]reflect.Value{
