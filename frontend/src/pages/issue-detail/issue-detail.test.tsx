...
vi.mock('@/shared/api/hooks', () => ({
  ...
  useBoard: () => ({
    data: {
      ...
      project_id: 'p1',
      project_key: 'TT',
      sprint: { id: 's1', name: 'Sprint 1', goal: '', state: 'active', issue_ids: [], velocity: 0, remaining_days: null, start_date: null, end_date: null },
    },
    isLoading: false,
    error: null,
  }),
  useSprints: () => ({
    data: [
      { id: 's1', name: 'Sprint 1', goal: '', state: 'active', issue_ids: [], velocity: 0, remaining_days: null, start_date: null, end_date: null },
    ],
    isLoading: false,
    error: null,
  }),
